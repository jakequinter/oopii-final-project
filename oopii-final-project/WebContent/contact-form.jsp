		...
		<div class="card" >
			<div class="card-body">
				...
				<fieldset class="form-group">
					...
					<input type="text" id="firstName" value="<c:out value='${contact.firstName}' />" class="form-control" name="firstName">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Last Name</label>
					<input type="text" id="lastName" value="<c:out value='${contact.lastName}' />" class="form-control" name="lastName">
				</fieldset>
